    ...
    <div className="my-4">
      <div className="flex justify-around gap-2 my-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="border hover:bg-[#4D4D4D] w-12 h-12 fill-[#4D4D4D] hover:fill-white border-gray-400 rounded-full flex items-center justify-center shadow-xl hover:shadow-gray-500/50 cursor-pointer"
        >
          <svg
            width="24"
            height="24"

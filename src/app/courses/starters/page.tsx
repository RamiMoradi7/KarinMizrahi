...
const LessonCard = ({
  ...
  return (
    <div className="relative m-4 w-full max-w-xs lg:max-w-md h-[480px] mb-6 transform transition-all hover:scale-105 hover:shadow-lg rounded-xl">
      ...
      <div className="p-6 w-full h-full bg-white rounded-xl shadow-lg space-y-4 flex flex-col justify-between transition-all">
        <div className="bg-[#EF4444] h-2 w-16 ml-auto mb-4 rounded"></div>
        <div>
          <span className="text-xl sm:text-2xl font-semibold text-[#EF4444]">
        ...
        <div className="flex-1 overflow-hidden scale-105 p-2">
  ...
  return (
    <div className="mt-32  relative flex flex-col  justify-center bg-zinc-100 text-white p-4 md:px-12">
      ...
      <div className="bg-white  text-black p-10 rounded-3xl shadow-2xl mt-12 mx-auto w-full max-w-4xl">
        ...
        <h2
          className={`text-xl lg:text-xl mt-6 text-center mb-8 lg:mb-12 text-[#EF4444] tracking-wide uppercase`}
        >
